        ...
        <div className={clsx("flex flex-col lg:flex-row w-full")}>
          ...
          <div className="w-full flex flex-col gap-y-6">
            ...
            <div className={clsx("flex w-full items-center")}>
              <div className="text-3xl md:mb-0 mb-6 font-extrabold w-full md:w-[320px] lg:w-[620px] text-center md:text-left">
            ...
            <div
              className={clsx(
                "w-full flex flex-row justify-center md:justify-start gap-x-2",
                "lg:px-2"
              )}
            >
              <div className="flex md:flex-row flex-col gap-x-2 gap-y-2 items-center">
                <AiOutlineWhatsApp className="text-4xl " />
                {/* <div className="font-light text-accent-primary/80">+91-9769642166</div> */}
              </div>
              <div className="flex gap-x-2 md:flex-row flex-col items-center">
